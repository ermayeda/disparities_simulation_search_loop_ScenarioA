...
/*effect of race on mortality for ages 45-100 to be identified from search loop
...
/*baseline hazard of stroke for exp=0 whites to be identified from search loop
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		...
		*ages 45 to 50
		...
		local strokerate10000pys45to50_exp0 = r(rate)
        if `r(rate)' > `target_strokerate45to50_exp0'+.001 {
           local toolow=0
           noisily di in red "I stopped at stk_lambda_exp0_45to50==`stk_lambda_exp0_45to50lt', strokerate10000pys45to50_exp0=`r(rate)'
        }
        else {
           noisily di in white "I did NOT stop at stk_lambda_exp0_45to50==`stk_lambda_exp0_45to50lt', strokerate10000pys45to50_exp0=`r(rate)'
        }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys50to55_exp0 = r(rate)
         if `r(rate)' > `target_strokerate50to55_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_50to55==`stk_lambda_exp0_50to55lt', strokerate10000pys50to55_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_50to55==`stk_lambda_exp0_50to55lt', strokerate10000pys50to55_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys55to60_exp0 = r(rate)
         if `r(rate)' > `target_strokerate55to60_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_55to60==`stk_lambda_exp0_55to60lt', strokerate10000pys55to60_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_55to60==`stk_lambda_exp0_55to60lt', strokerate10000pys55to60_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys60to65_exp0 = r(rate)
         if `r(rate)' > `target_strokerate60to65_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_60to65l==`stk_lambda_exp0_60to65lt', strokerate10000pys60to65_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_60to65==`stk_lambda_exp0_60to65lt', strokerate10000pys60to65_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys65to70_exp0 = r(rate)
         if `r(rate)' > `target_strokerate65to70_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_65to70==`stk_lambda_exp0_65to70lt', strokerate10000pys65to70_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_65to70==`stk_lambda_exp0_65to70lt', strokerate10000pys65to70_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys70to75_exp0 = r(rate)
         if `r(rate)' > `target_strokerate70to75_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_70to75==`stk_lambda_exp0_70to75lt', strokerate10000pys70to75_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_70to75==`stk_lambda_exp0_70to75lt', strokerate10000pys70to75_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.0001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys75to80_exp0 = r(rate)
         if `r(rate)' > `target_strokerate75to80_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_75to80==`stk_lambda_exp0_75to80lt', strokerate10000pys75to80_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_75to80==`stk_lambda_exp0_75to80lt', strokerate10000pys75to80_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys80to85_exp0 = r(rate)
         if `r(rate)' > `target_strokerate80to85_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_80to85==`stk_lambda_exp0_80to85lt', strokerate10000pys80to85_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_80to85==`stk_lambda_exp0_80to85lt', strokerate10000pys80to85_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys85to90_exp0 = r(rate)
         if `r(rate)' > `target_strokerate85to90_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_85to90==`stk_lambda_exp0_85to90lt', strokerate10000pys85to90_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_85to90==`stk_lambda_exp0_85to90lt', strokerate10000pys85to90_exp0=`r(rate)'
         }
      }
   }
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 qui stptime if (exposure==0), title(person-years) per(10000)
		 local strokerate10000pys90to95_exp0 = r(rate)
         if `r(rate)' > `target_strokerate90to95_exp0'+.001 {
            local toolow=0
            noisily di in red "I stopped at stk_lambda_exp0_90to95==`stk_lambda_exp0_90to95lt', strokerate10000pys90to95_exp0=`r(rate)'
         }
         else {
            noisily di in white "I did NOT stop at stk_lambda_exp0_90to95==`stk_lambda_exp0_90to95lt', strokerate10000pys90to95_exp0=`r(rate)'
         }
      }
   }
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_95to100 = -0.33
   *add lower bound guess here
   local g1_95to100l = -0.85
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
